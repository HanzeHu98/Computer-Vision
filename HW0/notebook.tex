...
Go to \href{https://piazza.com/ucsd/spring2019/cse152}{Piazza} and sign
...
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{\PYZsh{} The code for this problem is posted on Piazza. Sign up for the course if you have not. Then find}
        \PY{c+c1}{\PYZsh{} the function definition included in the post \PYZsq{}Welcome to CSE152\PYZsq{} to complete this problem.}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Iterative method took 1.2776107788085938 seconds
Vectorized method took 0.010944843292236328 seconds
...
image. The orginal image (RGB) has a warm color tone, being more
reddish. What will the image look like if you exchange the reds with the
greens? Merge the 2D images by swapping the red channel with the green
channel (GRB).

Next, write another function to rotate the original image 90 degrees
counterclockwise.

Finally, you will have \textbf{six images}, 1 original, 3 obtained from
channels, 1 from merging, and 1 from rotation. Using these 6 images,
create one single image by tiling them together \textbf{without using
loops}. The image will have 2x3 tiles making the shape of the final
image (2*512)x(3*512)x3. The order in which the images are tiled does
not matter. Display this image.

In addition to "Lenna.png", please pick another nxnx3 image yourself (or
reshape/crop to size nxnx3) and repeat the same operations. You will
show another tiled image with size (2*n)x(3*n)x3.
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}27}]:} \PY{c+c1}{\PYZsh{} Write your code here. Import the image and define the required funtions.}
         ...
         \PY{k}{def} \PY{n+nf}{getChannel}\PY{p}{(}\PY{n}{img}\PY{p}{,}\PY{n}{channel}\PY{p}{)}\PY{p}{:}
             ...
             \PY{n}{width} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
             \PY{n}{height} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
             \PY{n}{output1} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{[}\PY{n}{width}\PY{p}{,}\PY{n}{height}\PY{p}{]}\PY{p}{)}
             \PY{n}{output2} \PY{o}{=} \PY{n}{output1}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{p}{)}
             \PY{n}{output3} \PY{o}{=} \PY{n}{output1}\PY{o}{.}\PY{n}{copy}\PY{p}{(}\PY{p}{)}
             \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{width}\PY{p}{)}\PY{p}{:}
                 \PY{k}{for} \PY{n}{y} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{height}\PY{p}{)}\PY{p}{:}
                     \PY{n}{output1}\PY{p}{[}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{]} \PY{o}{=} \PY{n}{image}\PY{p}{[}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{,}\PY{l+m+mi}{0}\PY{p}{]}
                     \PY{n}{output2}\PY{p}{[}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{]} \PY{o}{=} \PY{n}{image}\PY{p}{[}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}
                     \PY{n}{output3}\PY{p}{[}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{]} \PY{o}{=} \PY{n}{image}\PY{p}{[}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{]}
         
             \PY{k}{if} \PY{n}{channel} \PY{o}{==} \PY{l+m+mi}{1}\PY{p}{:}
                 \PY{k}{return} \PY{n}{output1}
             \PY{k}{elif} \PY{n}{channel} \PY{o}{==} \PY{l+m+mi}{2}\PY{p}{:}
                 \PY{k}{return} \PY{n}{output2}
             \PY{k}{return} \PY{n}{output3}
         ...
         \PY{k}{def} \PY{n+nf}{mergeChannels}\PY{p}{(}\PY{n}{image1}\PY{p}{,}\PY{n}{image2}\PY{p}{,}\PY{n}{image3}\PY{p}{)}\PY{p}{:}
             ...
             \PY{n}{width} \PY{o}{=} \PY{n}{image1}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
             \PY{n}{height} \PY{o}{=} \PY{n}{image1}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
             \PY{n}{output} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{[}\PY{n}{width}\PY{p}{,} \PY{n}{height}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{]}\PY{p}{)}
             \PY{k}{for} \PY{n}{x} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{width}\PY{p}{)}\PY{p}{:}
                 \PY{k}{for} \PY{n}{y} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{height}\PY{p}{)}\PY{p}{:}
                     \PY{n}{output}\PY{p}{[}\PY{n}{x}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]} \PY{o}{=} \PY{n}{image2}\PY{p}{[}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{]}
                     \PY{n}{output}\PY{p}{[}\PY{n}{x}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]} \PY{o}{=} \PY{n}{image1}\PY{p}{[}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{]}
                     \PY{n}{output}\PY{p}{[}\PY{n}{x}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{]} \PY{o}{=} \PY{n}{image3}\PY{p}{[}\PY{n}{x}\PY{p}{,}\PY{n}{y}\PY{p}{]}
             \PY{k}{return} \PY{n}{output}
         
         
         \PY{k}{def} \PY{n+nf}{rotateImg}\PY{p}{(}\PY{n}{img}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}Function for rotating image with given degrees counterclockwise\PYZsq{}\PYZsq{}\PYZsq{}}
             \PY{n}{output} \PY{o}{=} \PY{n}{img}\PY{o}{.}\PY{n}{transpose}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}
             \PY{n}{output} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{flip}\PY{p}{(}\PY{n}{output}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{0}\PY{p}{)}
             \PY{k}{return} \PY{n}{output}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}28}]:} \PY{c+c1}{\PYZsh{} Test your function}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}35}]:} \PY{c+c1}{\PYZsh{} Write your code here for tiling the six images to make a single image and displaying it. }
         ...
         \PY{c+c1}{\PYZsh{} Show the tiled images for both \PYZsq{}Lenna.png\PYZsq{} and the image you pick.}
         
         \PY{k}{def} \PY{n+nf}{make3d}\PY{p}{(}\PY{n}{image}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}Takes a 2 dimensional image and change it into a 3 dimensional image\PYZsq{}\PYZsq{}\PYZsq{}}
             \PY{n}{width} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
             \PY{n}{height} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{shape}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
             \PY{n}{stack} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{[}\PY{n}{width}\PY{p}{,} \PY{n}{height}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}
             \PY{n}{concat} \PY{o}{=} \PY{n}{image}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{n}{width}\PY{p}{,} \PY{n}{height}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}
             \PY{n}{output} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{concatenate}\PY{p}{(}\PY{p}{(}\PY{n}{concat}\PY{p}{,} \PY{n}{concat}\PY{p}{,} \PY{n}{concat}\PY{p}{)}\PY{p}{,} \PY{n}{axis}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{)}
             \PY{k}{return} \PY{n}{output}
         
         \PY{k}{def} \PY{n+nf}{getResults}\PY{p}{(}\PY{n}{imgName}\PY{p}{)}\PY{p}{:}
             \PY{n}{image} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{n}{imgName}\PY{p}{)}
             ...
             \PY{n}{image4} \PY{o}{=} \PY{n}{mergeChannels}\PY{p}{(}\PY{n}{image1}\PY{p}{,} \PY{n}{image2}\PY{p}{,} \PY{n}{image3}\PY{p}{)}
             \PY{n}{image5} \PY{o}{=} \PY{n}{rotateImg}\PY{p}{(}\PY{n}{image}\PY{p}{)}
             
             \PY{c+c1}{\PYZsh{}make them 3D}
             \PY{n}{image1} \PY{o}{=} \PY{n}{make3d}\PY{p}{(}\PY{n}{image1}\PY{p}{)}
             \PY{n}{image2} \PY{o}{=} \PY{n}{make3d}\PY{p}{(}\PY{n}{image2}\PY{p}{)}
             \PY{n}{image3} \PY{o}{=} \PY{n}{make3d}\PY{p}{(}\PY{n}{image3}\PY{p}{)}
         
             \PY{n}{hstack1} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{hstack}\PY{p}{(}\PY{p}{(}\PY{n}{image}\PY{p}{,} \PY{n}{image1}\PY{p}{,} \PY{n}{image2}\PY{p}{)}\PY{p}{)}
             \PY{n}{hstack2} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{hstack}\PY{p}{(}\PY{p}{(}\PY{n}{image3}\PY{p}{,} \PY{n}{image4}\PY{p}{,} \PY{n}{image5}\PY{p}{)}\PY{p}{)}
             \PY{n}{final} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{vstack}\PY{p}{(}\PY{p}{(}\PY{n}{hstack1}\PY{p}{,} \PY{n}{hstack2}\PY{p}{)}\PY{p}{)}
             \PY{k}{return} \PY{n}{final}
         
         \PY{n}{lenna} \PY{o}{=} \PY{n}{getResults}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Lenna.png}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{lenna}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         \PY{n}{kaka} \PY{o}{=} \PY{n}{getResults}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Kaka.png}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{kaka}\PY{p}{)}
         \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
file. To convert the notebook to PDF: 1. You can find the export option
at File \(\rightarrow\) Download as \(\rightarrow\) PDF via LaTeX 2. You
can first export as HTML and then convert to PDF
